...
function generateMockResults() {
    ...
    const budgetRaw = document.getElementById("budget").value || "50000 PKR";

    // Extract numbers from the budget input to intelligently suggest costs
    const budgetNumber = parseInt(budgetRaw.replace(/\D/g, '')) || 50000;
    const suggestedCost = Math.floor(budgetNumber * 0.6); // 60% of budget
    ...
    const mockDataEn = [
        {
            ...
            income: `${Math.floor(suggestedCost * 5).toLocaleString()} PKR`,
            cost: `${suggestedCost.toLocaleString()} PKR`,
            diff: "Med",
        ...
        },
        {
            ...
            income: `${Math.floor(suggestedCost * 2).toLocaleString()} PKR`,
            cost: `${Math.floor(suggestedCost * 0.2).toLocaleString()} PKR`,
            diff: "Easy",
        ...
        },
        {
            ...
            income: `${Math.floor(suggestedCost * 8).toLocaleString()} PKR`,
            cost: `${Math.floor(suggestedCost * 0.3).toLocaleString()} PKR`,
            diff: "Hard",
        ...
        },
        {
            ...
            income: `Passive ${Math.floor(suggestedCost * 3).toLocaleString()}+`,
            cost: `${Math.floor(suggestedCost * 0.4).toLocaleString()} PKR`,
            diff: "Med",
        ...
        },
        {
            ...
            income: `${Math.floor(suggestedCost * 4).toLocaleString()} PKR`,
            cost: `${Math.floor(suggestedCost * 0.5).toLocaleString()} PKR`,
            diff: "Med",
